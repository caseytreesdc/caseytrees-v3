    ...
    <main>
      ...
      <div class="main__page-2">
        ...
        <section class="main__page-2-section-2">
          ...
          <p class="main__page-2-section-2-p">
            WE <span class="grey-highlight">PLANT 3,000+ TREES</span> EVERY YEAR
            TO REACH OUR
          </p>
          <p class="main__page-2-section-2-p">
        ...
        <section class="main__page-2-section-3">
          <img class="main__page-2-section-3-img" src="assets/main-pic-2.jpg" />
        </section>
      </div>
      ...
      <div class="main__page-3">
        ...
        <section class="main__page-3-section-3">
          <img class="main__page-3-section-3-img" src="assets/main-pic-3.jpg" />
        </section>
      </div>
      ...
      <div class="main__page-4">
        ...
        <section class="main__page-4-section-2">
          ...
          <p class="main__page-4-section-2-p">
            <span class="grey-highlight">CONSERVATION INITIATIVES</span> THAT
            HELP US
          </p>
          <p class="main__page-4-section-2-p">PROTECT US.</p>
        </section>
        <section class="main__page-4-section-3">
          <img class="main__page-4-section-3-img" src="assets/main-pic-4.png" />
        </section>
      </div>
    </main>
