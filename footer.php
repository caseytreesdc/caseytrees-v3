<footer class="footer__container">
      <div class="footer__column">
        <a
          href="http://caseytrees.org/"
          target="_blank"
          class="footer-logo__anchor"
        >
          <svg
            class="footer-logo"
            id="Layer_1"
      ...
      <div class="footer__column">
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytreesdc.github.io/ct-videos/ycyt"
            ><p class="footer__anchor-text">Your City, Your Trees</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytreesdc.github.io/ct-videos/branch-out"
            ><p class="footer__anchor-text">Branch Out</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytreesdc.github.io/ct-videos/tea-and-trees"
            ><p class="footer__anchor-text">Tea and Trees</p></a
          >
        </div>
      </div>
      <div class="footer__column">
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytrees.org/take-action/water/"
            ><p class="footer__anchor-text">Water</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytreesdc.github.io/treereportcard2019/"
            ><p class="footer__anchor-text">Tree Report Card 2019</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytrees.org/resources/blog/"
            ><p class="footer__anchor-text">The Leaflet</p></a
          >
        </div>
      </div>
      <div class="footer__column">
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytrees.org/resources-list/d-c-street-trees-map/"
            ><p class="footer__anchor-text">DC Street Trees</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytrees.maps.arcgis.com/apps/webappviewer/index.html?id=6b44d537d8fe49eebdc41c9e2c21ee9e"
            ><p class="footer__anchor-text">Cherry Blossoms Map</p></a
          >
        </div>
        <div class="footer__anchor-box">
          <a
            class="footer__anchor"
            href="https://caseytrees.org/resources-list/d-c-tree-inventory-map/"
            ><p class="footer__anchor-text">Inventory Map</p></a
          >
        </div>
      </div>
      <div class="footer__column">
        ...
        <div class="footer__social">
          <a
            ...
            ><svg
              viewBox="0 0 10 20"
              xmlns="http://www.w3.org/2000/svg"
              class="SocialLinks__logo"
            >
              <path
                d="M2.094 6.538H0v3.42h2.094V20h4.028V9.914h2.81l.3-3.376H6.12V4.615c0-.796.16-1.11.93-1.11h2.18V0H6.44C3.445 0 2.094 1.32 2.094 3.846v2.692z"
              />
            </svg>
          </a>
          <a
            class="footer__social-anchor"
            href="http://twitter.com/caseytrees"
            target="_blank"
            rel="noopener noreferrer"
            ><svg
              viewBox="0 0 21 17"
          ...
          <a
            class="footer__social-anchor"
            href="http://instagram.com/CaseyTrees"
            target="_blank"
            rel="noopener noreferrer"
            ><svg
              viewBox="0 0 18 17"
            ...
            >
              <path
                d="M15.71 7.192h-1.482c.108.418.172.856.172 1.308 0 2.89-2.342 5.23-5.23 5.23-2.89 0-5.23-2.34-5.23-5.23 0-.452.063-.89.17-1.308H2.63v7.192c0 .36.294.654.655.654h11.77c.36 0 .653-.293.653-.654V7.192zm0-4.577c0-.36-.294-.654-.656-.654h-1.96c-.362 0-.655.297-.655.658V4.58c0 .36.29.653.65.653h1.96c.363 0 .656-.292.656-.653V2.614zM9.17 5.23C7.364 5.23 5.9 6.695 5.9 8.5s1.464 3.27 3.27 3.27c1.805 0 3.27-1.465 3.27-3.27 0-1.806-1.465-3.27-3.27-3.27zM15.71 17H2.63c-1.08 0-1.96-.878-1.96-1.962V1.96C.67.88 1.548 0 2.63 0h13.08c1.084 0 1.962.878 1.962 1.96v13.08c0 1.084-.878 1.962-1.96 1.962z"
              />
            </svg>
          </a>
          <a
            class="footer__social-anchor"
            href="http://www.youtube.com/caseytrees"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
            ...
            >
              <path
                d="M25.412 3.85c-.39-3.084-1.7-3.51-4.307-3.675C17.398-.06 9.122-.06 5.412.175 2.805.343 1.495.766 1.106 3.85c-.29 2.288-.29 6.194 0 8.49.39 3.083 1.7 3.508 4.306 3.674 3.71.235 11.986.235 15.693 0 2.608-.166 3.918-.59 4.307-3.673.29-2.287.29-6.193 0-8.49zm-14.617 7.466V4.88l6.618 3.22-6.618 3.216z"
              />
            </svg>
          </a>
        </div>
